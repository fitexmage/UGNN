...
class CnnGegnConfig(ModelConfig):
    def __init__(self):
        ...
        self.device = "cuda:1"
        self.note = "no fcnn" # Anything you would like to put into the log
        ...
        self.one_hot_hour = False  # Only available for cnn_2
        ...
        self.o_grid_extra_cnn_layer_channels = [128, 64]
        self.o_grid_extra_fcnn_layer_channels = [64, 64]
        self.d_grid_cnn_layer_channels = [256, 128]
        self.d_grid_fcnn_layer_channels = [128, 128]
        self.d_grid_extra_cnn_layer_channels = [128, 64]
        self.d_grid_extra_fcnn_layer_channels = [64, 64]
