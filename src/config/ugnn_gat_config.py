...
class SAGEGegnConfig(ModelConfig):
    def __init__(self):
        super(SAGEGegnConfig, self).__init__()
        ...
        self.model_name = "cnnSAGE4cities"
        self.model_version = "20241115_grid1000"
        self.model_version = "20241125_grid1000"
        self.device = "cuda:1"
        ...
        self.train_cities = ["北京市","成都市", "厦门市", "乌鲁木齐市"]
        ...
        self.test_cities = ["上海市", "杭州市", "无锡市", "呼和浩特市"]
        self.test_cities = ["上海市", "杭州市", "深圳市", "武汉市", "天津市", "无锡市", "福州市", "南宁市", "兰州市", "呼和浩特市"]
        # self.test_cities = ["呼和浩特市"]
